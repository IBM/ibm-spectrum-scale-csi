...
// GetNodeAffinity returns kubernetes nodeAffinity based on architectures supported by Storage Scale CSI.
...
// GetNodeSelectorTerms returns corev1 NodeSelectorTerms based on architectures supported by Storage Scale CSI.
