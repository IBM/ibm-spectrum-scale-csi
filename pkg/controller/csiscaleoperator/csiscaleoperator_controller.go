...
import (
	...
	scalev1alpha1 "github.ibm.com/FSaaS/csi-scale-operator/pkg/apis/scale/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &scalev1alpha1.CSIScaleOperator{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &scalev1alpha1.CSIScaleOperator{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileCSIScaleOperator) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &scalev1alpha1.CSIScaleOperator{}
...
func newPodForCR(cr *scalev1alpha1.CSIScaleOperator) *corev1.Pod {
