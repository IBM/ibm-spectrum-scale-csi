...
// MockGetSpectrumScaleConnectorInt is a mock of GetSpectrumScaleConnectorInt interface.
type MockGetSpectrumScaleConnectorInt struct {
	ctrl     *gomock.Controller
	recorder *MockGetSpectrumScaleConnectorIntMockRecorder
}

// MockGetSpectrumScaleConnectorIntMockRecorder is the mock recorder for MockGetSpectrumScaleConnectorInt.
type MockGetSpectrumScaleConnectorIntMockRecorder struct {
	mock *MockGetSpectrumScaleConnectorInt
}

// NewMockGetSpectrumScaleConnectorInt creates a new mock instance.
func NewMockGetSpectrumScaleConnectorInt(ctrl *gomock.Controller) *MockGetSpectrumScaleConnectorInt {
	mock := &MockGetSpectrumScaleConnectorInt{ctrl: ctrl}
	mock.recorder = &MockGetSpectrumScaleConnectorIntMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockGetSpectrumScaleConnectorInt) EXPECT() *MockGetSpectrumScaleConnectorIntMockRecorder {
	return m.recorder
}

// GetSpectrumScaleConnector mocks base method.
func (m *MockGetSpectrumScaleConnectorInt) GetSpectrumScaleConnector(config settings.Clusters) (connectors.SpectrumScaleConnector, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSpectrumScaleConnector", config)
	ret0, _ := ret[0].(connectors.SpectrumScaleConnector)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetSpectrumScaleConnector indicates an expected call of GetSpectrumScaleConnector.
func (mr *MockGetSpectrumScaleConnectorIntMockRecorder) GetSpectrumScaleConnector(config interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSpectrumScaleConnector", reflect.TypeOf((*MockGetSpectrumScaleConnectorInt)(nil).GetSpectrumScaleConnector), config)
}
